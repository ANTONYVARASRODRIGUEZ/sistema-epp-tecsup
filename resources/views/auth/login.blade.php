...
<head>
    ...
    <style>
        ...
        .brand-logo { color: #003366; font-size: 2rem; }
    </style>
</head>
<body>
    <div class="card login-card p-4">
        <div class="text-center mb-4">
            ...
            <h3 class="fw-bold text-dark">EPP Sistema</h3>
            <p class="text-muted">Tecsup Norte - Acceso Administrativo</p>
        </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" class="form-control bg-light border-start-0" 
                           placeholder="admin@tecsup.edu.pe" value="{{ old('email') }}" required autofocus>
                </div>
            </div>
        ...
        <div class="text-center mt-4">
            <p class="small text-muted mb-0">Solo personal autorizado</p>
        </div>
    </div>
</body>
</html>